...
public class Test01 {
  ...
  public static void main(String[] args) {
    ...
    //
    //p.category = Category.COMPUTER_MOUSE_BLUETOOTH;// 예전 상수를 사용하는 방식.
    //p.category = Category.computer.mouse.bluetooth;  // static nested class 사용
    p.category = Category.computer.mouse.bluetooth.color.red;
    System.out.println(p.category);
    System.out.println(Category.computer.mouse.bluetooth.color.red);
