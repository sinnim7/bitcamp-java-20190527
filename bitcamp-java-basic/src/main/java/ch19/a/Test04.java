...
public class Test04 {
  ...
  public static void main(String[] args) {
    ...
    //
    Car obj2 = new Car() { // class ? extends 생략됨.
      @Override
      public void run() {
    ...
    //
    Pen obj4 = new Pen() {  // class ? extends Object implements Pen 생략됨.  Object를 상속.
      @Override
      public void write() {
    ...
    // 주의!
    // => 수퍼 클래스와 인터페이스를 동시에 지정해 익명 클래스를 만들 수 없음.
    // => 여러 인터페이스를 구현한 익명 클래스를 만들 수 없음.
    //Car obj5 = new Car, Pen(){}// 컴파일 오류! 이런 문법 없음.
    
  }
  
  // 스태틱 메서드 
  public static void m1() {
  // 다른 메서드(예 : main())에 정의된 로컬 클래스를 사용할 수 없음.
    //A obj = new A();// 컴파일 오류
