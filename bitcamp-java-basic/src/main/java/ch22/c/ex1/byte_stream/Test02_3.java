...
public class Test02_3 {
  public static void main(String[] args) throws Exception {
    ...
    BufferedOutputStream out = new BufferedOutputStream("temp/date.bin");
    ...
    for (int i = 0; i < 1000000; i++) {
      ...
      // 일단 byte[] 배열에 저장
      // 바이트 배열이 꽉 찼을 때 파일로 출력할 것.
      // 그래서 Test01_1.java 에서와 같이 1바이트씩 출력하는 것은 같지만,
      // 속도는 이 클래스가 더 빠르다.
    }

    // BufferedOutputStream은 바이트 배열이 꽉 찼을 때만 파일로 출력해서
    // 바이트 배열에 데이터가 남아 있을 경우 강제적으로 출력해야 함.
