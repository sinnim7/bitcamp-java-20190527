...
public class Test01_1 {
  ...
  public static void main(String[] args) throws Exception{
    ...
    out.write('간'); // 0xca04 => 0xEAB084 3바이트 출력

    //java -Dfile.encoding=UTF-8 -cp bin/main ch22.b.character_stream.Test01_1
    ...
    // 출력되는 코드 값이 달라진다.
    // 만약 이클립스에서 실행한다면 무조건 UTF-8로 인코딩(코드 값으로 변한)돼 출력됨.
    // 명령창(콘솔창)에서 실행한다면 위에서 설명한대로 OS에 따라 다르게 인코딩됨.
    // 
