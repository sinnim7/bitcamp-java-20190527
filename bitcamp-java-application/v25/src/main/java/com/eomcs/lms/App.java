...
public class App {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //=> java.util.Stack에서는 Vector 클래스의 Iterator를 리턴.
    //  Vector에서 제공하는 Iterator는 입력한 순서대로 값을 꺼낸다.
    //  즉 FIFO 방식으로 꺼내기 때문에 스택의 LIFO 방식과 맞지 않음.
    //  그래서 ArrayDeque를 사용하는 것.
    //  ArrayDeque에서 제공하는 Iterator는 LIFO 방식으로 값을 꺼냄.

    Deque<String> commandStack = new ArrayDeque<>(); //stack 방식임
